...
<div class="recomendet-block tabs clear container" style="display:none;">
    <div class="recomendet-buttons ">
        <div class="recomendet-button bx-recommended-button tab-button" style="display: none;">Покупают вместе</div>
        <div class="recomendet-button bx-viewed-button tab-button" style="display: none;">Недавно просмотренные</div>
    </div>

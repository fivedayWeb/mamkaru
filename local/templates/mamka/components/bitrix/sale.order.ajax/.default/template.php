...
if (strlen($request->get('ORDER_ID')) > 0) {
    ...
    <form action="<?= $APPLICATION->GetCurPage(); ?>" method="POST" name="ORDER_FORM" id="bx-soa-order-form"
        ...
        <div id="bx-soa-order" class="row bx-<?= $arParams['TEMPLATE_THEME'] ?>" style="opacity: 0">
            ...
            <div class="col-sm-9 bx-soa">
                ...
                <? if ($arParams['DELIVERY_TO_PAYSYSTEM'] === 'p2d'): ?>
                    ...
                    <div id="bx-soa-pickup" data-visited="false" class="bx-soa-section" style="display:none">
                        <div class="bx-soa-section-title-container">
                            ...
                            <div class="col-xs-12 col-sm-3 text-right"><a href="" class="bx-soa-editstep">показать на
                                    карте</a></div>
                        </div>
                        <div class="bx-soa-section-content container-fluid"></div>
                    </div>
                ...
                <div data-type="informer" style="display:none;" class="alert alert-danger" id="data-warning-container">
                    <div class="row">
                        <div class="col-xs-12" style="position: relative; padding-left: 48px;">
                            <div class="icon-warning"></div>
                            <div data-warning-text>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script type="text/javascript">
        ...
        BX.Sale.OrderAjaxComponent.init({
            ...
            basketItems: <?=json_encode($arResult['BASKET_ITEMS'])?>,
            propertyValidation: true,
            showWarnings: true,
            userData: <?=CUtil::PhpToJSObject(array(
                'URL' => 'https://' . $_SERVER['HTTP_HOST'] . '/bitrix/admin/user_edit.php?lang=ru&ID=' . $USER->GetID(),

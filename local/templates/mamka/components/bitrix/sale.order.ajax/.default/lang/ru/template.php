...
$MESS['SOA_ORDER_SUC1'] = "В течении одного часа с Вами свяжется специалист для подтверждения Вашего заказа и выставления ссылки на оплату.<br><br>
Товар остается зарезервирован за Вами при безналичной форме оплаты в течении 3-х часов, при наличной форме оплаты в течении одних суток или до момента курьерской доставки, если вы хотите оплатить при доставке. Если Вы не успеваете в указанное время - сообщите об этом менеджеру.<br><br>
Магазин работает с 10:00 - 20:00.<br><br>Менеджер подтвердит Ваш заказ и отправит ссылку на оплату в рабочее время.<br><br>
Вы можете следить за выполнением своего заказа в <a href=\"#LINK#\">Персональном разделе сайта</a>. Обратите внимание, что для входа в этот раздел вам необходимо будет ввести логин и пароль пользователя сайта.";

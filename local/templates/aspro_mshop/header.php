...
global $APPLICATION, $HIDE_CATALOG_MULTILEVEL, $TEMPLATE_OPTIONS, $arSite;
...
})(window,document,'script','dataLayer','GTM-MQHBBC5');</script>
			...
			<div class="header_wrap <?=strtolower($TEMPLATE_OPTIONS["HEAD_COLOR"]["CURRENT_VALUE"])?>">
				<div class="top-h-row">
					<div class="wrapper_inner">
						...
						<div class="phones">
							<a href="https://t.me/Dorc161Bot" target="_blank" class="telegram">
								<img src="/bitrix/components/aspro/social.info.mshop/images/svg/telegram.svg" alt="TELEGRAM" title="TELEGRAM" height="24"> 
								<span class="order_wrap_btn">Акции и полезные чек-листы</span>
							</a>
							<!--

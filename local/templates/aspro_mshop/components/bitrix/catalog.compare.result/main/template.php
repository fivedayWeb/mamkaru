...
<div class="bx_sort_container">
	...
	<span class="wrap_remove_button">
		...
		<span class="button grey_br transparent remove_all_compare icon_close" onclick="<?='CatalogCompareObj.MakeAjaxAction(\''.SITE_DIR.'catalog/compare.php?action=DELETE_FROM_COMPARE_RESULT&ID[]='.$arStr.'\');'?>"><?=GetMessage("CLEAR_ALL_COMPARE")?></span>
	</span>
</div>

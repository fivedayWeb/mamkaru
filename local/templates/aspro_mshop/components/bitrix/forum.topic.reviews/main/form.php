...
?> class="reviews-form">
	...
	<div style="position:relative; display: block; width:100%;">
		...
		if (!$arResult["IS_AUTHORIZED"]):
			...
			<div class="reviews-reply-fields">
				<div class="reviews-reply-field-user">
					<div class="form-control reviews-reply-field reviews-reply-field-author"><label for="REVIEW_AUTHOR<?=$arParams["form_index"]?>"><?=GetMessage("OPINIONS_NAME")?><?
							?><span class="star reviews-required-field"> *</span></label>
					...
					if ($arResult["FORUM"]["ASK_GUEST_EMAIL"]=="Y"):
						...
						<div class="form-control reviews-reply-field reviews-reply-field-email"><label for="REVIEW_EMAIL<?=$arParams["form_index"]?>"><?=GetMessage("OPINIONS_EMAIL")?></label>
		...
		<div class="form-control">
			<div class="reviews-reply-header"><label><?=$arParams["MESSAGE_TITLE"]?><span class="star reviews-required-field"> *</span></label></div>
		...
		if (strLen($arResult["CAPTCHA_CODE"]) > 0):
			...
			<div class="form-control bg register-captcha captcha-row clearfix reviews-reply-field reviews-reply-field-captcha">
				<div class="iblock label_block">
					<label for="captcha_word"><?=GetMessage("F_CAPTCHA_PROMT")?><span class="star reviews-required-field"> *</span></label>

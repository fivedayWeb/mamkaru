<?
	...
	if(\Bitrix\Main\Loader::includeModule('aspro.mshop')){
		...
		CMShop::AddComponentTemplateModulePageBlocksParams(__DIR__, $arPageBlocksParams, array('SECTION' => 'CATALOG_PAGE', 'OPTION' => 'CATALOG')); // add option value FROM_MODULE
	}
	...
	if(!isset($arCurrentValues["SECTIONS_LIST_PREVIEW_DESCRIPTION"]) || $arCurrentValues["SECTIONS_LIST_PREVIEW_DESCRIPTION"] === 'Y'){
	...
	$arTemplateParametersParts[]["SHOW_SECTION_DESC"] = Array(
		"NAME" => GetMessage("SHOW_SECTION_ROOT_PREVIEW"),
		"TYPE" => "CHECKBOX",
		"DEFAULT" => "Y",
		'REFRESH' => 'Y',
	...
	if(!isset($arCurrentValues["SHOW_SECTION_DESC"]) || $arCurrentValues["SHOW_SECTION_DESC"] === 'Y'){
	...
	$arTemplateParametersParts[] = Array(
		...
		"SHOW_SUBSECTION" => Array(
			"NAME" => GetMessage("SHOW_SUBSECTION"),
			"TYPE" => "CHECKBOX",
			"DEFAULT" => "Y",
			"REFRESH" => "Y",
			"PARENT" => "SECTIONS_SETTINGS",
		...
		"LANDING_POSITION" => Array(
			"NAME" => GetMessage("T_LANDING_POSITION"),
			"TYPE" => "LIST",
			"DEFAULT" => "BOTTOM",
			"VALUES" => ["TOP"=>GetMessage("T_LANDING_POSITION_TOP"), "BOTTOM"=>GetMessage("T_LANDING_POSITION_BOTTOM")],
			"PARENT" => "LIST_SETTINGS",
		),
		"LANDING_TITLE" => Array(

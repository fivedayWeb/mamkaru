...
<div class="review-detail">
	<div class="item-views reviews front">
		<?if(!$GLOBALS['bMobileForm']):?>
			<span class="jqmClose close"><?=CMShop::showIconSvg('', SITE_TEMPLATE_PATH.'/images/svg/Close.svg')?></span>
		<?endif;?>
		<div class="item <?=($bImage ? '' : 'wti')?><?=($bLogo ? ' wlogo' : '')?>">
			...
			<div class="bottom-block">
				...
				<div class="close-block">
						<span class="button vbig_btn wides jqmClose"><?=Loc::getMessage('CLOSE_POPUP');?></span>
				</div>
			</div>
		</div>
	</div>

...
else
{
	...
	//$orderObj = \Bitrix\Sale\Order::load($arResult['JS_DATA'][]);
	...
	<form action="<?=POST_FORM_ACTION_URI?>" method="POST" name="ORDER_FORM" id="bx-soa-order-form" enctype="multipart/form-data">
		...
		<input type="hidden" name="KASSA" value="<?=$_REQUEST['SITE_ID']?>">
	...
	<script>
		...
		var $val = '';
		var $val2 = '';
		var $familiya = $('#soa-property-53').val();
		var $name = $('#soa-property-54').val();
		var $otchestvo = $('#soa-property-55').val();

		var $familiya2 = $('#soa-property-56').val();
		var $name2 = $('#soa-property-57').val();
		var $otchestvo2 = $('#soa-property-58').val();

		$val = $familiya + ' ' + $name + ' ' + $otchestvo;
		$('#soa-property-1').val($val);
		console.log('ФИО: ', $val);

		$val2 = $familiya2 + ' ' + $name2 + ' ' + $otchestvo2;
		$('#soa-property-39').val($val2);
		console.log('ФИО: ', $val2);

	 	$('#soa-property-53').on('change',function(){
			$familiya = $(this).val();
			$val = $familiya + ' ' + $name + ' ' + $otchestvo;

			$('#soa-property-1').val($val);
			console.log('Фамилия изменена: ', $val);
		});

		$('#soa-property-54').on('change',function(){
			$name = $(this).val();
			$val = $familiya + ' ' + $name + ' ' + $otchestvo;

			$('#soa-property-1').val($val);
			console.log('Имя изменен: ', $val);
		});

		$('#soa-property-55').on('change',function(){
			$otchestvo = $(this).val();
			$val = $familiya + ' ' + $name + ' ' + $otchestvo;

			$('#soa-property-1').val($val);
			console.log('Отчество изменен: ', $val);
		});

		$('#soa-property-56').on('change',function(){
			$familiya2 = $(this).val();
			$val2 = $familiya2 + ' ' + $name2 + ' ' + $otchestvo2;

			$('#soa-property-39').val($val2);
			console.log('Отчество изменен: ', $val2);
		});

		$('#soa-property-57').on('change',function(){
			$name2 = $(this).val();
			$val2 = $familiya2 + ' ' + $name2 + ' ' + $otchestvo2;
		...
		$('#soa-property-58').on('change',function(){
			$otchestvo2 = $(this).val();
			$val2 = $familiya2 + ' ' + $name2 + ' ' + $otchestvo2;
		...
		//console.log($('#soa-property-1').val());
	</script>
	<?

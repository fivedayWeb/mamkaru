...
if (CModule::IncludeModule("catalog"))
{
	...
	while ($ar = $rsCatalog->Fetch())
	{
		...
		if(isset($ar["OFFERS_IBLOCK_ID"]) && $ar["OFFERS_IBLOCK_ID"] && $ar["LID"] == SITE_ID)
		{
...
if (!empty($arResult["ELEMENTS"]) && CModule::IncludeModule("iblock")){
	...
	$bHideNotAvailable = (\Bitrix\Main\Config\Option::get('aspro.mshop', 'SEARCH_HIDE_NOT_AVAILABLE', 'N') == 'Y');

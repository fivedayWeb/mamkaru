...
if($arResult["ITEMS"]){?>
	...
	<?$bActiveFilter = \Aspro\Functions\CAsproMshop::checkActiveFilterPage($arParams["SEF_RULE_FILTER"]);?>
			...
			<form name="<?echo $arResult["FILTER_NAME"]."_form"?>" action="<?echo $arResult["FORM_ACTION"]?>" method="get" class="smartfilter">
				<div class="bx_filter_parameters_box title">
					<div class="bx_filter_parameters_box_title filter_title <?=($bActiveFilter && $bActiveFilter[1] != 'clear' ? 'active-filter' : '')?>">
						<?=CMShop::showIconSvg('', SITE_TEMPLATE_PATH.'/images/svg/catalog/filter.svg', '', '', true, false)?>
				...
				<div class="bx_filter_parameters">
					...
					foreach($arResult["ITEMS"] as $key => $arItem){
					    if(isset($arItem["ASPRO_FILTER_SORT"]) && $arItem["VALUES"]){
							...
							<div class="bx_filter_parameters_box bx_sort_filter <?=$class;?>" data-expanded="<?=($arItem["DISPLAY_EXPANDED"] ? $arItem["DISPLAY_EXPANDED"] : "N");?>" data-prop_code="<?=strtolower($arItem["CODE"]);?>" data-property_id="<?=$arItem["ID"]?>">
								...
								<?=CMShop::showIconSvg('down colored_theme_hover_bg-el', SITE_TEMPLATE_PATH.'/images/svg/trianglearrow_down.svg', '', '', true, false)?>
								</div>
					...
					<div class="bx_filter_parameters_box prices<?=(isset($arResult['PRICE_SET']) && $arResult['PRICE_SET'] == 'Y' ? ' set' : '');?>">
						...
						<div class="bx_filter_parameters_box_title title rounded3 " >
							...
							<span class="delete_filter colored_theme_bg_hovered_hover">
								<?=CMShop::showIconSvg("delete_filter", SITE_TEMPLATE_PATH.'/images/svg/catalog/cancelfilter.svg', '', '', false, false);?>
							</span>							
							<?=CMShop::showIconSvg("down colored_theme_hover_bg-el", SITE_TEMPLATE_PATH.'/images/svg/trianglearrow_down.svg', '', '', true, false);?>
						</div>
						<div class="bx_filter_block">
							...
							<div class="bx_filter_button_box active clearfix">
								<span class="btn button btn-default"><?=Loc::getMessage("CT_BCSF_SET_FILTER")?></span>
								<span data-f="<?=Loc::getMessage('CT_BCSF_SET_FILTER')?>" data-fi="<?=Loc::getMessage('CT_BCSF_SET_FILTER_TI')?>" data-fr="<?=Loc::getMessage('CT_BCSF_SET_FILTER_TR')?>" data-frm="<?=Loc::getMessage('CT_BCSF_SET_FILTER_TRM')?>" class="bx_filter_container_modef"></span>
							</div>
						</div>
					</div>
							...
							<div class="bx_filter_block <?=($arItem["CODE"]=="IN_STOCK" ? "limited_block" : "");?>" <?=$style;?>>
								...
								switch ($arItem["DISPLAY_TYPE"]){
									...
									default://CHECKBOXES
										...
										<?if($arItem['CODE'] == 'IN_STOCK'):?>
											<div class="bx_filter_parameters_box_title title prices rounded3 ">
										<?endif;?>
								...
								<?if($arItem['CODE'] != 'IN_STOCK'):?>
									<div class="bx_filter_button_box active clearfix">
										<span class="btn btn-default button"><?=Loc::getMessage("CT_BCSF_SET_FILTER")?></span>
										<span data-f="<?=Loc::getMessage('CT_BCSF_SET_FILTER')?>" data-fi="<?=Loc::getMessage('CT_BCSF_SET_FILTER_TI')?>" data-fr="<?=Loc::getMessage('CT_BCSF_SET_FILTER_TR')?>" data-frm="<?=Loc::getMessage('CT_BCSF_SET_FILTER_TRM')?>" class="bx_filter_container_modef"></span>
									</div>
								<?endif;?>
							</div>
					...
					<?}?>
					<button class="bx_filter_search_reset btn-link-text colored_theme_text_with_hover<?=($bActiveFilter && $bActiveFilter[1] != 'clear' ? '' : ' hidden');?>" type="reset" id="del_filter" name="del_filter" data-href="">
						<?=CMShop::showIconSvg("down", SITE_TEMPLATE_PATH.'/images/svg/catalog/cleanfilters.svg', '', '', true, false);?>
					...
					<div class="bx_filter_button_box active hidden colored_theme_bg">
						<div class="bx_filter_block">
							<div class="bx_filter_parameters_box_container clearfix">
								...
								<button class="bx_filter_search_reset btn button btn-default btn-transparent round-ignore<?=($bActiveFilter && $bActiveFilter[1] != 'clear' ? '' : ' hidden');?> pull-left" type="reset" id="del_filter1" name="del_filter1" data-href="" title="<?=Loc::getMessage("CT_BCSF_DEL_FILTER")?>">
									<?=CMShop::showIconSvg("reset", SITE_TEMPLATE_PATH.'/images/svg/catalog/cleanfilters_big.svg', '', '', true, false);?>
								</button>
								<div class="filter-bnt-wrapper"><button class="bx_filter_search_button button btn btn-default btn-transparent round-ignore" type="submit" id="set_filter" name="set_filter" data-href=""><?=Loc::getMessage("CT_BCSF_SET_FILTER")?></button></div>

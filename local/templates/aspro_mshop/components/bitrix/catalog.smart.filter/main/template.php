		...
		<div class="bx_filter_section">
			<form name="<?echo $arResult["FILTER_NAME"]."_form"?>" action="<?echo $arResult["FORM_ACTION"]?>" method="get" class="smartfilter">
				<div class="bx_filter_parameters_box active title">
					<div class="bx_filter_parameters_box_title"><?=GetMessage('CT_BCSF_FILTER_TITLE');?></div>
				</div>
									...
									<div class="bx_filter_select_container">
										<div class="bx_filter_select_block" onclick="smartFilter.showDropDownPopup(this, '<?=CUtil::JSEscape($key)?>')">
											...
											<div class="bx_filter_select_popup" data-role="dropdownContent" style="display: none;">
												<ul>
													<li>
														<label data-role="label_<?=$arCur["CONTROL_ID"]?>" for="<?="all_".$arCur["CONTROL_ID"]?>" class="bx_filter_param_label" data-role="label_<?="all_".$arCur["CONTROL_ID"]?>" onclick="smartFilter.selectDropDownItem(this, '<?=CUtil::JSEscape("all_".$arCur["CONTROL_ID"])?>')">
															<? echo GetMessage("CT_BCSF_FILTER_ALL"); ?>
														</label>
													</li>
												<?
					...
					<div class="bx_filter_button_box active">
						<div class="bx_filter_block">
							<div class="bx_filter_parameters_box_container clearfix">
								...
								<button class="bx_filter_search_button button small" type="submit" id="set_filter" name="set_filter" data-href="" value="<?=GetMessage("CT_BCSF_SET_FILTER")?>" ><?=GetMessage("CT_BCSF_SET_FILTER")?></button>
								<button class="bx_filter_search_reset button small transparent color_in_mobile" type="reset" id="del_filter" name="del_filter" data-href="" value="<?=GetMessage("CT_BCSF_DEL_FILTER")?>" >
									<span class="reset_title"><?=GetMessage("CT_BCSF_DEL_FILTER")?></span>
									<?=CMShop::showIconSvg("reset", SITE_TEMPLATE_PATH.'/images/svg/catalog/cleanfilters_big.svg', '', 'mobile_reset', true, false);?>
								</button>
							</div>
						</div>
					</div>

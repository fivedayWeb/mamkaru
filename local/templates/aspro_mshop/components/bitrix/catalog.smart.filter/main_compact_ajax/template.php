					...
					<div class="bx_filter_button_box active hidden colored_theme_bg">
						<div class="bx_filter_block">
							<div class="bx_filter_parameters_box_container">
								...
								<button class="bx_filter_search_reset button btn btn-default btn-transparent round-ignore<?=($bActiveFilter && $bActiveFilter[1] != 'clear' ? '' : ' hidden');?> pull-left" type="reset" id="del_filter1" name="del_filter1" data-href="" title="<?=Loc::getMessage("CT_BCSF_DEL_FILTER")?>">
									<?=CMShop::showIconSvg("reset", SITE_TEMPLATE_PATH.'/images/svg/catalog/cleanfilters_big.svg', '', '', true, false);?>
								</button>
								<div class="filter-bnt-wrapper"><button class="bx_filter_search_button button btn btn-default btn-lg btn-transparent round-ignore" type="button" id="set_filter1" name="set_filter1" data-href=""><?=Loc::getMessage("CT_BCSF_SET_FILTER")?></button></div>
							</div>
						</div>
					</div>
				<?endif;?>

...
$bLinkTitle = (COption::GetOptionString('aspro.mshop', 'BASKET_FLY_TITLE_LINK', '', SITE_ID) == 'Y' ? true : false);
...
<?$frame = $this->createFrame()->begin('');?>
	...
	<div class="opener">
		<div class="basket_count<?=($normalCount?"":" empty")?> small" data-type="AnDelCanBuy"  title="<?=$title_basket?>">
		...
		<div class="wish_count<?=($delayCount?"":" empty")?> small" data-type="DelDelCanBuy"  title="<?=$title_delay?>">
	...
	?>
		<div class="basket_sort">
			<span class="basket_title">
				<?if($bLinkTitle):?>
					<a href="<?=$arParams['PATH_TO_BASKET']?>"><?=GetMessage("BASKET_TITLE");?></a>
				<?else:?>

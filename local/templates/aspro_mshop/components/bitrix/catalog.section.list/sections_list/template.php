	...
	?>
		<div class="section_item" id="<?=$this->GetEditAreaId($arItems['ID']);?>">
			<table class="section_item_inner">
				<tr>
					...
					<td class="section_info">
						<ul>
							...
							} else if($arParams["SECTIONS_LIST_PREVIEW_DESCRIPTION"] !== 'N') {
				...
				<?if($arParams["SHOW_SUBSECTION"]=="Y" && $arParams["SECTIONS_LIST_PREVIEW_DESCRIPTION"] !== 'N'){
					if ($arSection[$arParams["SECTIONS_LIST_PREVIEW_PROPERTY"]]):?>

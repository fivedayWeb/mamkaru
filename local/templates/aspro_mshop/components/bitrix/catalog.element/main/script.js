...
(function (window) {
    ...
    window.JCCatalogOnlyElement.prototype = {
      ...
      setPriceAction: function () {
        ...
        if (
          ...
          typeof this.currentPrices[this.currentPriceSelected].PRICE !==
            "undefined" &&
          this.currentPrices[this.currentPriceSelected].PRICE
        ) {
          setPriceItem(
    ...
    switch (this.config.mainPictureMode) {
      ...
      case "MAGNIFIER":
        ...
        if (!!this.magnify.obBigImg && !!this.magnify.obBigSlider) {
          this.magnify.obMagnifyArea = this.obPictAligner.appendChild(
            BX.create("DIV", {
              props: {
          ...
          this.magnify.obMagnifier = this.magnify.obBigSlider.appendChild(
            BX.create("DIV", {
              props: {
          ...
          this.magnify.obMagnifyPict = this.magnify.obMagnifier.appendChild(
            BX.create("IMG", {
              props: {
          ...
          BX.bind(
            this.obPict,
            "mouseover",
            BX.delegate(this.showMagnifier, this)
          );
        }
        break;
      case "POPUP":
        this.obPopupPict = new BX.PopupWindow(
          "CatalogElementPopup_" + this.visual.ID,
          null,
          {
            autoHide: false,
            offsetLeft: 0,
        ...
        BX.bind(
          this.obPict,
          "click",
          BX.delegate(this.showMainPictPopup, this)
        );
        BX.adjust(this.obPict, { style: { cursor: "pointer" } });
        BX.addCustomEvent(
          this.obPopupPict,
          "onAfterPopupShow",
          BX.proxy(this.onPopupWindowShow, this)
        );
        BX.addCustomEvent(
          this.obPopupPict,
          "onPopupClose",
          BX.proxy(this.onPopupWindowClose, this)
        );
        break;
      default:
        break;
    ...
    if (-1 < intNumber && intNumber < this.obTreeRows.length) {
      ...
      if (!!RowItems && 0 < RowItems.length) {
        ...
        if (selectMode) {
          ...
          lineContainer[intNumber].style.display = !$(
            lineContainer[intNumber]
          ).find("option[selected=selected]").length
            ? "none"
            : "";
        } else {
          lineContainer[intNumber].style.display = !$(
  ...
  window.JCCatalogElement.prototype.ChangeInfo = function () {
    ...
    if (-1 < index) {
      ...
      if (
        ...
        console.log("arPriceItem.PRINT_VALUE = " + arPriceItem.PRINT_VALUE);
      ...
      if (arMShopOptions["THEME"]["CHANGE_TITLE_ITEM"] == "Y") {
        ...
        this.offers[index].POSTFIX =
          arMShopOptions["THEME"]["HIDE_SITE_NAME_IN_TITLE"] == "Y"
            ? ""
            : this.offers[index].POSTFIX;
      ...
      for (var i in slider) {
        if (typeof slider[i] == "object") {
          slideHtml +=
            ...
            '<a href="' +
            slider[i].BIG.src +
            '" data-fancybox-group="item_slider" class="fancy" title="' +
            slider[i].TITLE +
            '"><img border="0" src="' +
            slider[i].SMALL.src +
            '" alt="' +
  ...
  window.JCCatalogElement.prototype.setPriceMatrix = function (sPriceMatrix) {
    ...
    if (!!this.obPrice.price) {
      ...
      console.log("sPriceMatrix = " + sPriceMatrix);
      var eventdata = {
      ...
      if (typeof obPrices == "object") {
        ...
        for (var j in obPrices) {
          if (obPrices[j]) {
            ...
            //poulhouse
            if (this.offers[this.offerNum].MAX_QUANTITY > 0) {
              console.log("2");
              strPrice +=
              ...
              console.log("3");
              strPrice +=
                '<span class="values_wrapper not_qt">Цену уточняйте<br>у менеджера</span>';
            }
            //poulhouse
            ...
            strPrice += "</div>";
            console.log(obPrices[j].DISCOUNT_VALUE);
            console.log(obPrices[j].VALUE);

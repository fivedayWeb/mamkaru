...
$APPLICATION->SetTitle("Интернет-магазин для малышей");
?>
...
<div class="grey_bg reviews">
	<div class="wrapper_inner">
		<?$APPLICATION->IncludeComponent(
			...
			array(
				"IBLOCK_TYPE" => "aspro_mshop_content",
				"IBLOCK_ID" => CMShopCache::$arIBlocks[SITE_ID]["aspro_mshop_content"]["aspro_mshop_add_review"][0],
				"NEWS_COUNT" => "15",
				"SORT_BY1" => "SORT",
				"SORT_ORDER1" => "ASC",
				"SORT_BY2" => "ID",
				"SORT_ORDER2" => "DESC",
				"FILTER_NAME" => "arFrontLink",
				"FIELD_CODE" => array(
					0 => "PREVIEW_PICTURE",
					1 => "PREVIEW_TEXT",
					2 => "DETAIL_PICTURE",
